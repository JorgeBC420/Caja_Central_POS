...
class DatabaseManager:
    ...
    def _ensure_db_initialized(self):
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS promociones (
                ...
                fecha_inicio TEXT,
                fecha_fin TEXT,
                tipo TEXT, -- ejemplo: '2x1', 'descuento', etc.
                valor REAL,
                activo INTEGER DEFAULT 1
                )
            """)
            # Usuario admin por defecto (con hash seguro)
    ...
    def cambiar_password_usuario(self, username, nuevo_password):
        hashed_pw = hashlib.sha256(nuevo_password.encode()).hexdigest()
    ...
    # --- CRUD de productos, usuarios, clientes, ventas, etc. ---
